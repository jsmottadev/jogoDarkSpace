class SoundEffects {
  constructor() {
    this.shootSounds = [
      new Audio("src/assets/audios/shoot.wav"),
      new Audio("src/assets/audios/shoot.wav"),
      new Audio("src/assets/audios/shoot.wav"),
      new Audio("src/assets/audios/shoot.wav"),
      new Audio("src/assets/audios/shoot.wav"),
    ...
    this.explosionSound = new Audio("src/assets/audios/explosion.wav");
    this.levelUpSound = new Audio("src/assets/audios/levelUp.mp3");
